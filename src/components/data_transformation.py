## its basically for feature engineering
...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            logging.info('Data tranformation initiates')
            ...
            logging.info("Error in data transforation")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("preprecessor pickle is created and saved")
